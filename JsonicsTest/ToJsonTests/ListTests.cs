...
namespace JsonicsTests.ToJsonTests
{
    ...
    public class ListTests
    {
        ...
        [Test]
        public void ToJson_ListDecimal_CorrectJson()
        {
            //arrange
            var converter = JsonFactory.Compile<List<decimal>>();

            //act
            string json = converter.ToJson(new List<decimal>{-11.12M,2.4M,3M,4M,5.5M});
        ...
        [Test]
        public void ToJson_ListNullableDecimal_CorrectJson()
        {
            //arrange
            var converter = JsonFactory.Compile<List<decimal?>>();

            //act
            string json = converter.ToJson(new List<decimal?>{-11.12M,2.4M,null,3M,4M,5.5M});
