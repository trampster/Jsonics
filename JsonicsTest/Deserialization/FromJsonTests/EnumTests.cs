...
namespace JsonicsTests.FromJsonTests
{
    ...
    public class EnumTests
    {
        ...
        [TestCase(" 1", TestEnum.One)]
        [TestCase("\n 1", TestEnum.One)]
        public void BoolProperty_CorrectlyDeserialized(string jsonValue, TestEnum expected)
        {
            //arrange
            //act
        ...
        [TestCase(" 1", TestEnum.One)]
        [TestCase("\n 1", TestEnum.One)]
        public void BoolValue_CorrectlyDeserialized(string jsonValue, TestEnum expected)
        {
            //arrange
            //act
