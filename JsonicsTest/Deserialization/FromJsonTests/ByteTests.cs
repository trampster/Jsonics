...
namespace JsonicsTests.FromJsonTests
{
    ...
    public class ByteTests
    {
        ...
        [TestCase("\n 255", 255)]
        [TestCase(" 0", 0)]
        public void BoolProperty_CorrectlyDeserialized(string jsonValue, byte expected)
        {
            //arrange
            //act
        ...
        [TestCase("\n 255", 255)]
        [TestCase(" 0", 0)]
        public void BoolValue_CorrectlyDeserialized(string jsonValue, byte expected)
        {
            //arrange
            //act
