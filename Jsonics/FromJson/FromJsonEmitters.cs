...
namespace Jsonics.FromJson
{
    public class FromJsonEmitters
    {
        ...
        public FromJsonEmitters(Type jsonObjectType, LocalBuilder lazyStringLocal, JsonILGenerator generator)
        {
            ...
            _emitters.Add(new LazyStringEmitter<float>(lazyStringLocal, generator, this, "ToFloat"));
            _emitters.Add(new LazyStringEmitter<float?>(lazyStringLocal, generator, this, "ToNullableFloat"));
            ...
            _emitters.Add(new DateTimeEmitter(lazyStringLocal, generator, this, "ToDateTime"));
