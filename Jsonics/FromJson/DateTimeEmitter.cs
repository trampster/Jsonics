...
namespace Jsonics.FromJson
{
    public class DateTimeEmitter : FromJsonEmitter
    {
        ...
        public DateTimeEmitter(LocalBuilder lazyStringLocal, JsonILGenerator generator, FromJsonEmitters emitters, string methodName)
        ...
        public override void Emit(LocalBuilder indexLocal, Type type)
        {
            ...
            Type tupleType = StaticCall<DateTime, DateTimeEmitter>(_methodName, _generator);
